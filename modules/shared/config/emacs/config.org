...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Michiel Bruins"
    user-mail-address "1969831+mrbruins@users.noreply.github.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/michielbruins/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/michielbruins/bin" "/profile/bin" "/Users/michielbruins/.npm-packages/bin" "/Users/michielbruins/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
